...
NOTE: The information below refers to the upstream `unoconv/unoserver-docker` repository and may not fully reflect this fork.
NOTE: In this fork, `Dockerfile` is intentionally kept aligned with upstream. Use `Dockerfile.custom` for branch-specific hardened builds.
